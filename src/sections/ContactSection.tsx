  ...
  return (
    <footer className="border-t border-sky-200" id="contact">
      <div className="mx-auto w-full max-w-6xl px-5 py-16 sm:px-8">
        <div className="rounded-lg border border-sky-200 bg-gradient-to-r from-sky-500 to-violet-500 p-6 text-white shadow-lg shadow-sky-200/60 sm:p-8">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.24em]">Contact</p>
            <div className="mt-5 grid gap-3">
              <a
                className="inline-flex w-fit items-center gap-3 rounded-lg bg-white px-5 py-3 text-sm font-semibold text-sky-700 transition hover:bg-sky-50"
