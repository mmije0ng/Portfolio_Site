  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-indigo-50 to-violet-50 text-slate-800">
      <section className="mx-auto w-full max-w-6xl px-5 py-16 sm:px-8">
        ...
        <div className="grid gap-6 rounded-lg border border-sky-200/80 bg-gradient-to-br from-sky-50/74 via-white/40 to-violet-50/66 p-6 shadow-sm shadow-sky-100/60 backdrop-blur-sm md:grid-cols-[1fr_220px] md:items-center">
          <div>
          ...
          <div className="rounded-lg bg-gradient-to-br from-sky-500 to-violet-500 p-5 text-white">
            <p className="text-[11px] font-semibold text-white/85 sm:text-xs">Total Projects</p>
            <p className="mt-2 text-3xl font-extrabold sm:text-[2rem]">{projects.length}</p>
          </div>
        </div>
